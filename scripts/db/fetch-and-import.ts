/** biome-ignore-all lint/suspicious/noExplicitAny: data import */
import { Database } from "bun:sqlite";
import path from "node:path";

const FIREBASE_URL = "https://alpha-dog-9ce25.firebaseio.com/.json";
...
try {
  ...
  console.warn("⚠️  Skipping data refresh — existing database data will be used");
  process.exit(0);
}
...
runImport();
db.close();
console.log("✅ Database refreshed from Firebase");
